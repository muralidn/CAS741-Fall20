...
def get_input(filename):
    ...
    outfile = open("log.txt", "a")
    print("var 'r_t' assigned ", end="", file=outfile)
    ...
    outfile = open("log.txt", "a")
    print("var 'K_d' assigned ", end="", file=outfile)
    ...
    outfile = open("log.txt", "a")
    print("var 'K_p' assigned ", end="", file=outfile)
    ...
    outfile = open("log.txt", "a")
    print("var 't_step' assigned ", end="", file=outfile)
    ...
    outfile = open("log.txt", "a")
    print("var 't_sim' assigned ", end="", file=outfile)
