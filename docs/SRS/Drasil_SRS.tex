...
\begin{figure}
\begin{center}
\includegraphics[width=0.7\textwidth]{../../../datafiles/PIDController/Fig_PDController.png}
...
\item[Power Plant Parameters:\phantomsection\label{dcGainTimeConst}]{The DC Gain and Time Constant of the First Order System ( from \hyperref[pwrPlant]{A: Power plant} and \hyperref[pwrPlantTxFnx]{A: Transfer Function} ) are assumed to be 1, and 2 seconds respectively. There is no physical significance to the values chosen. (RefBy: \hyperref[likeChgPP]{LC: DC Gain and Time Constant} and \hyperref[GD:gdPowerPlant]{GD: gdPowerPlant}.)}
\end{itemize}
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & The  Transfer Function  of a  First Order System is characterized by this equation ( from \hyperref[pwrPlantTxFnx]{A: Transfer Function} ).
...
\begin{itemize}
\item[Second-Order Power Plant:\phantomsection\label{likeChgIC}]{The Power Plant may be changed into a second-order system ( from  \hyperref[pwrPlantTxFnx]{A: Transfer Function} ).}
\item[DC Gain and Time Constant:\phantomsection\label{likeChgPP}]{The DC Gain and Time Constant may be changed to be supplied by the user ( from  \hyperref[dcGainTimeConst]{A: Power Plant Parameters} ).}
\end{itemize}
